...
public class ViewOppurtunity extends ProjectSpecificMethods{

	public ViewOppurtunity click_on_NewButton() {
		pause(2000);
	...
	public ViewOppurtunity search_Oppurtunity(String Oppurtunity_Name) {
		pause(2000);
	...
	public ViewOppurtunity viewAllActions_and_Edit() {
		pause(1000);
	...
	public ViewOppurtunity viewAllActions_and_Delete() {
		WebElement viewAction = locateElement(Locators.XPATH, "(//table//tbody//tr//td[8])[1]");
		waitForApperance(viewAction);
		click(viewAction);
	...
	public ViewOppurtunity enter_OppurtunityName(String Oppurtunity_name) {
	...
	public ViewOppurtunity choose_CloseDate(String Date) {
	...
	public ViewOppurtunity select_Stage(String StageValue) {
	...
	public  ViewOppurtunity select_deliveryStatus(String StatusValue) {
	...
	public ViewOppurtunity enter_desc(String descValue) {
	...
	public ViewOppurtunity save_oppurtunity() {
	...
	public ViewOppurtunity verify_Oppurtunity_Edited_sucessfully(String Stage) {
	...
	public  ViewOppurtunity verify_oppurtunity_deleted_Succesfully(String Oppurtunity_name) {
		...
		String expectedmsg = "Oppurtunity "+Oppurtunity_name+" was deleted.";
